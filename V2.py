...
class LightStudentDelete(tk.Frame):
    def __init__(self, master):
        ...
        self.Deletesty = ttk.Style()
        self.Deletesty.configure('Treeview', rowheight=46, fieldbackground="#ffffff")
        self.Deletesty.map('Treeview', background=[('selected', '#a1a1a1'), ('focus', '#919191')])
